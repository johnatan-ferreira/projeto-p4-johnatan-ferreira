...
4 jogadores.
"Pedro", "Marcos", "Tiago", "Lucas" -> "Vencedor: Lucas"

2 jogadores.
"Filipe", "Mateus" -> "Vencedor: Mateus"

3 jogadores
"Pedro", "Filipe", "Tiago" -> "Vencedor: Pedro"

1 jogador.
"Tiago" -> "Vencedor: Tiago"

5 jogadores.
"Pedro", "Marcos", "Mateus", "Tiago", "Lucas" -> "Vencedor: Marcos"

7. Casos-limite

Caso a entrada seja nula, o programa não prossegue, exigindo que seja informado ao menos um jogador.
Quando há apenas um jogador ele é declarado automaticamente campeão.
Em caso de nomes repetidos, para evitar ambiguidade, será gerado internamento um id próprio para cada participante.
